      ...
      <div class="form-section">
        ...
        <div class="form-row">
          <div class="form-group">
            ...
            <input type="text" name="id_orcamento" required>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" name="tipo_cpf_cnpj" required>
          </div>
          <div class="form-group">
          ...
          <div class="fertilizante">
            ...
            <div class="form-group">
              ...
              <select name="fertilizante_tipo[]" required>
                ...
                <option value="Sacaria 50KG">Sacaria 50KG</option>
              </select>
            </div>
            <button type="button" class="remove-btn" onclick="removeFertilizante(this)">Remover</button>
          </div>
        </div>
        <button type="button" class="add-btn" onclick="addFertilizante()">+ Adicionar</button>
      </div>
